...
router.post('/register', async (req, res) => {
  try {
    ...
    // Not associating vehicles during user registration anymore.
    // Vehicle registration must be done by the motorista via /vehicles
    // and alunos/responsáveis devem usar /me/join para se vincular a um veículo existente.
